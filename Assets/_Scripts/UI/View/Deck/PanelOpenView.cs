...
{
    [SerializeField] private float _scacle;
    ...
    public void Open()
    {
        ...
        _coroutineScale = StartCoroutine(Scale(Vector3.zero, Vector3.one * _scacle));
    }
    ...
    public void Close()
    {
        ...
        _coroutineScale = StartCoroutine(Scale(Vector3.one * _scacle, Vector3.zero, () => gameObject.SetActive(false)));
    }
